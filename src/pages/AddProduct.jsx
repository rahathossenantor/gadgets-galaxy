...
const AddProduct = () => {
    ...
    const addProduct = async (e) => {
        ...
        try {
            const res = await fetch("https://gadgets-galaxy-server.vercel.app/add-product", {
                method: "POST",
                headers: {
                ...
                <form onSubmit={addProduct}>
                    ...
                    <div className="flex 2xl:flex-row xl:flex-row lg:flex-row md:flex-col flex-col gap-5 mb-5">
                        <div className="2xl:w-1/2 xl:w-1/2 lg:w-1/2 md:w-full w-full">
                            ...
                            <input type="text" required placeholder="Enter product name" id="productName" name="productName" className="input input-bordered w-full" />
                        </div>
                        <div className="2xl:w-1/2 xl:w-1/2 lg:w-1/2 md:w-full w-full">
                            <label htmlFor="brand" className="font-semibold text-lg">Brand:</label>
                            <select id="brand" required name="brand" className="input input-bordered w-full">
                    ...
                    <div className="flex 2xl:flex-row xl:flex-row lg:flex-row md:flex-col flex-col gap-5 mb-5">
                        <div className="2xl:w-1/2 xl:w-1/2 lg:w-1/2 md:w-full w-full">
                            ...
                            <select id="productType" required name="productType" className="input input-bordered w-full">
                        ...
                        <div className="2xl:w-1/2 xl:w-1/2 lg:w-1/2 md:w-full w-full">
                            ...
                            <input type="number" required placeholder="Enter product price" id="price" name="price" className="input input-bordered w-full" />
                        </div>
                    </div>
                    {/* third row */}
                    <div className="flex 2xl:flex-row xl:flex-row lg:flex-row md:flex-col flex-col gap-5 mb-5">
                        <div className="2xl:w-1/2 xl:w-1/2 lg:w-1/2 md:w-full w-full">
                            ...
                            <input type="number" required min={0} max={5} placeholder="Rate this product (Min 0, Max 5)" id="ratings" name="ratings" className="input input-bordered w-full" />
                        </div>
                        <div className="2xl:w-1/2 xl:w-1/2 lg:w-1/2 md:w-full w-full">
                            <label htmlFor="details" className="font-semibold text-lg">Short Description:</label>
                            <input type="text" required placeholder="Type short description" id="details" name="details" className="input input-bordered w-full" />
                        </div>
                    </div>
                    {/* fourth row */}
                    <div className="mb-5">
                        <label htmlFor="photo" className="font-semibold text-lg">Product Image:</label>
                        <input type="text" required placeholder="Enter photo URL" id="photo" name="photo" className="input input-bordered w-full" />
                    </div>
